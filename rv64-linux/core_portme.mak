...
# CC = /opt/syntacore/riscv-gcc-8.1.0-gad407a5/bin/riscv64-unknown-linux-gnu-gcc
# CC ?= /opt/syntacore/riscv-gcc/bin/riscv64-unknown-linux-gnu-gcc
CC := /home/irina/work/riscv-gcc/bin/riscv64-unknown-linux-gnu-gcc
# Flag: CFLAGS
#	Use this flag to define compiler options. Note, you can add compiler options from the command line using XCFLAGS="other flags"
# PORT_CFLAGS = -O3 -flto -funroll-loops -DPERFORMANCE_RUN=1
#PORT_CFLAGS = -O2 -fno-common -funroll-loops -finline-functions --param max-inline-insns-auto=20 -falign-functions=4 -falign-jumps=4 -fomit-frame-pointer -fsched-spec-load -fsched-stalled-insns-dep=2 -falign-loops=4 --param inline-min-speedup=2
PORT_CFLAGS = -O3 -fno-common -funroll-loops -finline-functions --param max-inline-insns-auto=16 -falign-functions=4 -falign-jumps=4 -fomit-frame-pointer -fsched-spec-load -fsched-stalled-insns-dep=2 -falign-loops=4 --param inline-min-speedup=2
FLAGS_STR = "$(PORT_CFLAGS) $(XCFLAGS) $(XLFLAGS) $(LFLAGS_END)"
CFLAGS = -march=rv64gc -mabi=lp64d -mstrict-align -static $(PORT_CFLAGS) -I$(PORT_DIR) -I. -DFLAGS_STR=\"$(FLAGS_STR)\"
#Flag: LFLAGS_END
